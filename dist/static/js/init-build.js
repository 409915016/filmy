...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_qiniu_bucket__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_Config__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__libs_simple_modal__ = __webpack_require__(78);
...
__WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].filter('i18n', __WEBPACK_IMPORTED_MODULE_2__libs_i18n__["a" /* default */]);
...
new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_4__models_Config__["a" /* default */].load(true).then(function (config) {
      if (!config) return;
      var url = location.protocol + '//' + location.host;

      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__libs_simple_modal__["a" /* default */])('Warning', 'This Filmy is already inited.', '<a href="' + url + '" class="btn btn-primary" role="button">OK</a>');
  ...
  methods: {
    ...
    submit: function submit(evt) {
      ...
      __WEBPACK_IMPORTED_MODULE_3__models_qiniu_bucket__["a" /* default */].fetchPutToken(this.password, null, { ak: ak, sk: sk })
      // 由密码取得Token
      .then(function (putToken) {
        var fileData = new Blob([__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()({ ak: ak, sk: sk })], { type: 'application/json' });
        fileData.name = 'secret-' + _this2.password + '.json';
        // 由初始化页面构成 json 文件上传至 七牛云存储
        return __WEBPACK_IMPORTED_MODULE_3__models_qiniu_bucket__["a" /* default */].putFile(fileData.name, fileData, { putToken: putToken }).then(function () {
          return putToken;
        });
      }).then(function (putToken) {
        // 取得壁纸地址
        switch (_this2.background) {
          ...
          case 'file':
            ...
            return __WEBPACK_IMPORTED_MODULE_3__models_qiniu_bucket__["a" /* default */].putFile(key, file, { putToken: putToken }).then(function () {
              var asset = __WEBPACK_IMPORTED_MODULE_3__models_qiniu_bucket__["a" /* default */].key(key);
              return asset.url();
            });
        }
        ...
        return __WEBPACK_IMPORTED_MODULE_4__models_Config__["a" /* default */].update(_this2.password, config, true);
      }).then(function () {
        var url = location.protocol + '//' + location.host;
        var adminUrl = url + '/admin';

        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__libs_simple_modal__["a" /* default */])('Congratulation!', 'Your Filmy is ready for use.', '\n              <a href="' + url + '" class="btn btn-primary" role="button">Go to Filmy</a>\n              <a href="' + adminUrl + '" class="btn" role="button">Go to Admin Tools</a>\n            ');
      }).catch(function (err) {
        new Button(evt.target, 'reset');
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__libs_simple_modal__["a" /* default */])('Error', err.message, '<button class="btn btn-primary" role="button">OK</button>');
      });
    }
  }
});
...
//# sourceMappingURL=init-build.js.map